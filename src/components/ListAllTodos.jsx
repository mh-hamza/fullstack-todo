  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-lg mx-auto mt-8">
      ...
      {todos.length > 0 ? (
            ...
            <li key={todo.id} className="flex items-center justify-between bg-gray-100 p-4 rounded-lg shadow-sm">
              ...
              <div className="flex items-center">
                <div className="rounded-full border-2 border-gray-500 w-6 h-6 flex items-center justify-center mr-4">
                  ...
                  <svg className="fill-current hidden w-4 h-4 text-blue-500 pointer-events-none" viewBox="0 0 20 20">
              ...
              <div className="flex">
                <button 
                  ...
                  onClick={() => console.log("Delete clicked for:", todo.id)}
                >
                  <FaTrash />
                </button>
                <button 
        ...
        <p className="text-gray-600">No todos found. Add some tasks to get started!</p>
      )}
    </div>
  );
};
